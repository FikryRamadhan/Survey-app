    ...
    <div class="w-full max-w-4xl bg-gray-800 rounded-lg shadow-lg overflow-hidden flex">
        ...
        <div class="w-full md:w-1/2 p-8">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <button type="submit" class="w-full bg-green-600 text-white font-bold py-2 rounded-lg hover:bg-green-600 transition">LOGIN</button>

                <div class="flex items-center justify-center mt-6">
                    <span class="text-white">Belum punya akun?</span><a href="{{ route('register') }}" class="text-sm ml-2 text-blue-600 hover:underline">Daftar!</a>
                </div>
            </form>
        </div>
    </div>
